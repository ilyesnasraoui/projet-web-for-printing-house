...
<body>
  <!--================ Start Header Menu Area =================-->
	...
	<section id="contact">
      ...
      <div class="container">
      <div class="contact">
        <form method="POST" action="avis1.php" enctype="multipart/form-data">
            ...
            <div>
              <script language="javascript" type="text/javascript">
                  function calculeLongueur(){
                      ...
                      iLongueur = document.getElementById('text').value.length;
                      if (iLongueur>30) {
                        document.getElementById('text').value = document.getElementById('text').value.substring(0,300);
                        iLongueurRestante = 0;
                      }
                      else {
              ...
              <span>Si vous avez un avis vous pouvez écrire ci-dessous</span>
              <textarea onblur="calculeLongueur();" onfocus="calculeLongueur();" onkeydown="calculeLongueur();" onkeyup="calculeLongueur();" name="text" id="text" value="" class="form-control"  placeholder="300 Lettres au maximum" /></textarea>
