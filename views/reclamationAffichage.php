...
<body>
  ...
  <!-- ================ start banner area ================= -->
 <div class="back">
  <h2><center>Réclamation</h2>
  </br>
</div>
    <!---->
    <div class=" cart-items">

       <h3 class="container h-100"> Consultez votre réclamation</h3>
     </br>
     </br>
    ...
    <div class="in-check" >
      <ul class="unit">
        <center>
      <table border="2" class="table table-striped table-bordered dataTable no-footer" class="x_panel">
      <tr>
      <td>Probléme</td>
  ...
  <td><form method="POST" action="reclamationSupprimer.php">
  <input type="submit" name="supprimer" value="supprimer">
  <input type="hidden" value="<?PHP echo $row['autre']; ?>" name="autre">
  </form>
  </td>
  <td><a href="reclamationModification.php?email=<?PHP echo $row['email']; ?>">
  Modifier</a></td>
  </tr>
