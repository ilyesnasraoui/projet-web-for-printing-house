        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              ...
              <li class="nav-item active"><a class="nav-link" href="logout.php">Déconnexion</a></li>
            </ul>
	...
	<section id="contact">
      ...
      <div class="contact">
        ...
        <div class=" contact-top">
          ...
          <li class="nav-item"><a class="nav-link" style="color:DodgerBlue;" href="reclamationAffichage.php">Afficher vos réclamations</a></li>
        </div>
      </form>
    </div>
  </div>
