...
<form  method="post" action="modprom.php" onsubmit="return verif()">
    <table>
        ...
        <tr>
            <td><label for="delai">delai</label></td>
            <td><input type="text"  name="delai" value="<?php echo $delai ?>"></td>
        </tr>
        <tr>
            <td><label for="fk_id_produit">fk_id_produit</label></td>
            <td><input  type="text"  name="fk_id_produit" value="<?php echo $fk_id_produit ?>"></td>
        </tr>
        <input type="hidden" name="id_promo" value="<?php echo $id_promo ?>">
        <tr>
            <td ><input type="submit" value="Modifier" class="btn btn-warning"></td>
        </tr>
    </table>
</form>
    </fieldset>
