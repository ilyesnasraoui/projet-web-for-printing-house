<div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span>Société Imprimerie Aicha De Distribution!</span></a>
            </div>
...
<!--
                  <li><a><i class="fa fa-edit"></i> Stock <span class="fa fa-chevron-down"></span></a>
                       <ul class="nav child_menu">
                      <li><a href="ajouts1.php">ajout stock</a></li>
                      <li><a href="mstock1.php">modifier stock</a></li>
                      <li><a href="sstock1.php">supprimer stock</a></li>
                ...
                <li><a><i class="fa fa-edit"></i> carte fidelité <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="ajoutecartefidelite.php">ajout carte fidelité</a></li>
