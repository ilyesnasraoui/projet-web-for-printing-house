...
if(isset($_POST['id_produit']) and isset($_POST['nom']) and isset($_POST['couleur']) and isset($_POST['prix']) and isset($_POST['typee']) and isset($_POST['description']) and isset($_POST['dateC'])) {
   echo "here";
