...
<head>
  <meta charset="utf-8">
  <title>Afficher carte de fidelité</title>
</head>
<body>
  <fieldset >
    <form name="f1"  method="POST" action="ajoutecartefidelite.php" onSubmit="return verif()" >
<center><legend><h2> Ajout carte de fidelité </h2></legend></center>
       <table id="example1" class="table table-striped">

        <tr>
        <th> id client </th>
        <th><input type="text" name="id_client" value=""/></th>
      </tr>

          <th> nb points</th>
          <th><input type="number" name="points" value=""/></th>
        </tr>
