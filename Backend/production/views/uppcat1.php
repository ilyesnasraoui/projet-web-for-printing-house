  ...
  {
    $list=$prod->getCategorie($_POST['updateID']);
  }
...
<html lang="en" dir="ltr">
  ...
  <body>
    <fieldset >
      ...
      {
        ?>
      <form name="f1" style="height: 800px;" method="POST" action="uppcat.php" onSubmit="return verif() " enctype="multipart/form-data" >
 <center><legend><h2> Modifier Categorie</h2></legend></center>
         <table id="example1" class="table table-striped">
          
          </tr>
            <th> </th>
            <th><input type="hidden" name="id_cat" value="<?php echo $row['id_cat']; ?>"/></th>
          </tr>
          </tr>
            <th> nom cat </th>
