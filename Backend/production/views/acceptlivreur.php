...
if(isset($_POST["cin"])  and isset($_POST["prenom"]) and isset($_POST["nom"]) and isset($_POST["telephone"]) and isset($_POST["birthday"])  and isset($_POST["license"]) and isset($_POST["license_validity"]) and isset($_POST["adresse"]) and isset($_POST["mdp"]) and isset($_POST["login"]) and isset($_POST["joiniable"]) )
{
