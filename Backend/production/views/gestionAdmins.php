...
foreach($listeAdmins as $row){
	...
	<input type="submit"titre="submit" name="supprimer" value="supprimer">
	<input type="hidden" value="<?PHP echo $row['id']; ?>" name="ref">
	</form>
	</td>
	<td><form method="POST" action="editRole.php">
	<input type="submit"titre="submit" name="Editer Droits" value="Editer Droits">
	<input type="hidden" value="<?PHP echo $row['id']; ?>" name="ref">
