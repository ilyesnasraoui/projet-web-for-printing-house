  ...
  <section class="section-margin--small mb-5">
            ...
            <div class="common-filter">
              ...
              <div class="price-range-area">
                ...
                <div class="value-wrapper d-flex">
                  ...
                  <span>$</span>
                  <div id="lower-value">90DT</div>
                  <div class="to">to</div>
                  <span>$</span>
                  <div id="upper-value">500DT</div>
                </div>
              </div>
            </div>
          </div>-->
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  ...
                  <div class="card-body">
                    <p>Accessories</p>
                    <h4 class="card-product__title"><a href="#">Wedding card</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="s1.jpg" alt="">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Accessories</p>
                    <h4 class="card-product__title"><a href="#">A stamp of the office</a></h4>
                    <p class="card-product__price">200DT</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  ...
                  <div class="card-body">
                    <p>Accessories</p>
                    <h4 class="card-product__title"><a href="#">Wedding card</a></h4>
                    <p class="card-product__price">90DT</p>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-4">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  ...
                  <div class="card-body">
                    <p>Accessories</p>
                    <h4 class="card-product__title"><a href="#">Certificate</a></h4>
                    <p class="card-product__price">115DT</p>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-4">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  ...
                  <div class="card-body">
                    <p>Accessories</p>
                    <h4 class="card-product__title"><a href="#">certificate</a></h4>
                    <p class="card-product__price">140DT</p>
                  </div>
                </div>
              </div>
            </div>
	...
	<section class="related-product-area">
        ...
        <div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
          <div class="single-search-product-wrapper">
            <div class="single-search-product d-flex">
              <a href="#"><img src="img/v2.jpg" alt=""></a>
              <div class="desc">
                  <a href="#" class="title">Wedding card</a>
