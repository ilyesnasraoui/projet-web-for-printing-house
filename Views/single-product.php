			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="../Backend/production/views/<?php echo $row["image"]; ?>" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<ul class="list">
							<li><a href="#"><span>Availibility</span> : <?php if($row["quantite"] >0) echo "IN STOCK"; else echo "N/A";?></a></li>
						</ul>
